              ...
              <div className="space-y-8 lg:col-span-7 lg:pl-10">
                <div className="text-center">
                  ...
                  <p className="text-lg leading-relaxed text-gray-600">
                    ...
                    proporcionar tranquilidade e segurança jurídica através de um
                    atendimento humanizado, onde você fala diretamente com o
                    especialista responsável pelo seu caso.
                  </p>
                </div>
