...
import { 
  Phone, MessageCircle, Scale, Shield, Award, Clock, Users, ShoppingCart, Home as HomeIcon, Briefcase, ChevronRight, CheckCircle2
} from 'lucide-react'
...
const areas = [
  ...
  { title: "Indenizações e Cobranças", desc: "Atuação incisiva na recuperação de valores e reparação de danos.", icon: Scale, link: "/indenizacoes-cobrancas" },
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 relative">
              <div className="relative aspect-[4/5] overflow-hidden rounded-3xl shadow-xl">
                <img src={lawyerImage} alt="Dr. Rogério CBJ" className="object-cover object-top w-full h-full scale-105 hover:scale-100 transition-transform duration-1000" />
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="grid lg:grid-cols-12 gap-16 items-center">
              <div className="lg:col-span-5 relative">
                <img src={lawyerImage} alt="Dr. Rogério" className="w-full h-auto object-cover relative z-10 grayscale-[20%] rounded-3xl shadow-lg" />
              </div>
              <div className="lg:col-span-7 space-y-8 lg:pl-10">
                <div>
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed mb-6">Com excelência técnica e rigor ético, o escritório é pautado pela transparência e pelo compromisso inabalável com os resultados de cada cliente.</p>
                </div>
                <div className="pt-6">
